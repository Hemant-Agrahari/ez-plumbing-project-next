        ...
        <div className="footer">
          <div className="container-xl">
            <div className="row">
                ...
                <div className="footer-brand-call">
                  ...
                  <p className="toll_f_num">
                    ...
                    <a href="tel:+18443225539" className="toll_free">
                      <Image
                        src="/images/green-icon-call.png"
                        alt="call green icon"
                  ...
                  <div className="footer-col info-col">
                    <div className="social-links">
                      ...
                      <Link href="https://x.com/EZHeatAndAir" target="_blank">
                        <img
              ...
              <div className="col-md-9 col-lg-9 mt-4 mt-md-0">
                <div className="footer-about">
                  <div className="footer-col quick-link-first-col">
                  ...
                  {/* <div className="footer-col">
                    ...
                    <ul className="footer-col-links ">
                      <li>
                        <Link href="/san-diego-heating-repair">
