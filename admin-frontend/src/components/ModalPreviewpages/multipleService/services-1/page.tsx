...
import { sliderblogsSettings4 } from "@/helper/sliderSettings";
        ...
        <section className="container service-boxe-col">
          <div className="avoid-inefficient-leak-get-sla px-0">
            ...
            <div className="service-boxes">
              {data?.section2 && (
                <Slider {...sliderblogsSettings4} className="w-100">
                  {data?.section2?.card &&
        ...
        <div className="container">
          {data.content2 &&
            data.content2.map((item: any, index: any) => (
              <div
                className="count-on-ez-plumbing-usa-for-s px-0 service-1s"
                key={index}
              >
                {index % 2 === 0 ? (
                  <>
