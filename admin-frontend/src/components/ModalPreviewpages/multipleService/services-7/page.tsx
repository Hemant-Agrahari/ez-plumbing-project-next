...
import { sliderblogsSettings1 } from "@/helper/sliderSettings";
...
const ServicePreview = ({ data }: any) => {
  ...
  return (
    <div className="services">
        ...
        <section className="container service-boxe-col">
          <div className="avoid-inefficient-leak-get-sla px-0">
            ...
            <div className="service-boxes">
              {data?.section2 &&
                <Slider {...sliderblogsSettings1} className="w-100">
      ...
      <section className="max-container w-100">
        <div className="container">
          {data.content && data?.content.map((item: any, index: any) => (
            <div className="ez-plumbing-guarantees-repair px-0 service-7" key={index}>
      ...
      <section className="w-100 max-container">
        <div className="container">
          {data.content2 && data.content2.map((item: any, index: any) => (
            <div className="count-on-ez-plumbing-usa-for-s px-0 service-7s" key={index}>
              {index % 2 === 0 ? (
                <>
      ...
      {/* content2 */}
      {/* {data.content2 && data.content2.map((value: any, index: any) => {
        <section className="container" key={value.id}>
          <div className="ez-plumbing-guarantees-repair px-0">
            <h2 className="ez-plumbing-guarantees-container">
              <p className="ez-plumbing-guarantees" dangerouslySetInnerHTML={{ __html: value.contentTitle }}>
              </p>
            </h2>
            <div className="image-container">
              <Image
              ...
              <div className="info-columns">
                <div className="contact-ez-plumbing"
                  dangerouslySetInnerHTML={{ __html: value.contentText }}>
                </div>
              </div>
            </div>
          </div>
