...
import ServicePreview from "@/components/ModalPreviewpages/multipleService/services-13/page";
...
const Services: React.FC<ServicesProps> = ({ serviceData }) => {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      precise_section: serviceData?.precise_section || {
        title: '',
        card: [{ cardTitle: '', cardText: '' }]
      },


      slab_Leaksection: serviceData?.slab_Leaksection || {
        title: '',
        card: [{ cardTitle: '', cardText: '' }]
      },
      ...
      faq: serviceData?.faq || [''],
      template: serviceData?.template || "services_13",
      categories: [''],
    },
      ...
      try {
        ...
        const jsonData = {
          ...
          section1: {
            ...
            description: values.section1.description
          },
          section2: {
          ...
          section3: {
            title: values.section3.title,
            card: values.section3.card.map((item: any) => ({
              cardTitle: item.cardTitle,
              cardText: item.cardText,
            }))
          },
          ...
          precise_section: {
            title: values.precise_section.title,
            card: values.precise_section.card.map((item: any) => ({
              cardTitle: item.cardTitle,
              cardText: item.cardText,
            }))
          },
          // slab_Leaksection: serviceData?.slab_Leaksection || {
          slab_Leaksection: values?.slab_Leaksection || {
            title: values.slab_Leaksection.title,
            card: values.slab_Leaksection.card.map((item: any) => ({
              cardTitle: item.cardTitle,
              cardText: item.cardText,
            }))
          },
        ...
        // console.log("shanu",jsonData.slab_Leaksection)
  ...
  const handleAddsection2Card = (e: any) => {
    e.preventDefault()
  ...
  const handleRemovesection2Card = (index: any) => {
    const updatedCards = formik.values.section2.card.filter((_: any, i: any) => i !== index);
    formik.setFieldValue('section2.card', updatedCards);
  };

  const handleAddsection3Card = (e: any) => {
    e.preventDefault()
    formik.setFieldValue('section3.card', [
      ...formik.values.section3.card,
      { cardTitle: '', cardSubTitle: '', cardText: '', cardImage: null }
    ]);
  };

  const handleRemovesectionCard3 = (index: any) => {
    const updatedCards = formik.values.section3.card.filter((_: any, i: any) => i !== index);
    formik.setFieldValue('section3.card', updatedCards);
  };


  const handleprecisesectionAddCard = (e: any) => {
    e.preventDefault()
    formik.setFieldValue('precise_section.card', [
      ...formik.values.precise_section.card,
      { cardTitle: '',  cardText: '' }
    ]);
  };

  const handleprecisesectionRemoveCard = (index: any) => {
    const updatedCards = formik.values.precise_section.card.filter((_: any, i: any) => i !== index);
    formik.setFieldValue('precise_section.card', updatedCards);
  };

  const handleslab_LeaksectionAddCard = (e: any) => {
    e.preventDefault()
    formik.setFieldValue('slab_Leaksection.card', [
      ...formik.values.slab_Leaksection.card,
      { cardTitle: '',  cardText: '' }
    ]);
  };


  const handleslab_LeaksectionRemoveCard = (index: any) => {
    const updatedCards = formik.values.slab_Leaksection.card.filter((_: any, i: any) => i !== index);
    formik.setFieldValue('slab_Leaksection.card', updatedCards);
  };
            ...
            <div className="col-7">
              ...
              <div className={styles.mb4}>
                ...
                <div className="mb-3">
                  <input
                    name="section1.title"
                    placeholder=" Section1 Title"
                    className="form-control"
                    value={formik.values.section1.title}
                    onChange={formik.handleChange}
                  />
                </div>
                ...
                <div className="mb-3">
                  <Editor
                    ...
                    value={formik.values.section1.description}
                    onChange={(e: any) => formik.setFieldValue(`section1.description`, e.target.value)}
                  />
                </div>
              ...
              <div className={styles.mb4}>
                ...
                {formik.values.section2.card && formik.values.section2.card.map((card: any, index: any) => (
                  <div key={index} style={{ marginBottom: '20px', position: 'relative' }}>
                    ...
                    />
                    <FaTrash
                      onClick={() => handleRemovesection2Card(index)}
                ...
                {/* {formik.values.section2.card.length < 4 && */}
                <div className={styles.btnEnd}>
                  <Button
                    text="Add Card"
                    type="button"
                    handle={handleAddsection2Card}
              ...
              <div className={styles.mb4}>
                ...
                {formik.values.section3.card && formik.values.section3.card.map((card: any, index: any) => (
                  <div key={index} style={{ marginBottom: '20px', position: 'relative' }}>
                    <h5>{index + 1} Card </h5>
                    <DynamicInput
                      type="text"
                      name={`section3.card[${index}].cardTitle`}
                      placeholder="Card Title"
                      value={card.cardTitle}
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                    ...
                    <Editor
                      name={`section3.card[${index}].cardText`}
                      value={card.cardText}
                      onChange={(e: any) => formik.setFieldValue(`section3.card[${index}].cardText`, e.target.value)}
                    />
                    <FaTrash
                      onClick={() => handleRemovesectionCard3(index)}
                      className={styles.trashIcon}
                      style={{ right: "10px", top: "5px" }}
                    />
                  </div>
                ...
                {formik.values.section3.card.length < 4 &&
                  <div className={styles.btnEnd}>
                    <Button
                      text="Add Card"
                      type="button"
                      handle={handleAddsection3Card}
                      className={styles.btnStyle}
                    >
                      Add Card
                    </Button>
              ...
              <div className={styles.mb4}>
                ...
                <div className="mb-3">
                  ...
                  <div className="mb-3">
                    <input
                      name="precise_section.title"
                      placeholder=" precise_section Title"
                      className="form-control"
                      value={formik.values.precise_section.title}
                      onChange={formik.handleChange}
                    />
                  </div>
                </div>
                {formik.values.precise_section.card && formik.values.precise_section.card.map((card: any, index: any) => (
                  <div key={index} style={{ marginBottom: '20px' }}>
                    <h5>{index + 1} Precise_section Card</h5>
                    <DynamicInput
                      type="text"
                      name={`precise_section.card[${index}].cardTitle`}
                      placeholder="Card Title"
                      value={card.cardTitle}
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                    ...
                    <Editor
                      name={`precise_section.card[${index}].cardText`}
                      value={card.cardText}
                      onChange={(e: any) => formik.setFieldValue(`precise_section.card[${index}].cardText`, e.target.value)}
                    />
                    <FaTrash
                      onClick={() => handleprecisesectionRemoveCard(index)}
                      className={styles.trashIcon}
                    />
                  </div>
                ))}
                {formik.values.precise_section.card.length < 4 && <div className={styles.btnEnd}>
                  <Button
                    text="Add Card"
                    type="button"
                    handle={handleprecisesectionAddCard}
                    className={styles.btnStyle}
                  >
                    Add Card
                  </Button>
              ...
              {/* new slab_Leaksection section added */}
              ...
              <div className={styles.mb4}>
                ...
                <div className="mb-3">
                  <div className="mb-3">
                    <input
                      name="slab_Leaksection.title"
                      placeholder=" slab_Leaksection Title"
                      className="form-control"
                      value={formik.values.slab_Leaksection.title}
                      onChange={formik.handleChange}
                    />
                  </div>
                  ...
                  {/* <Editor
                    name={`slab_Leaksection.title`}
                    value={formik.values.slab_Leaksection.title}
                    onChange={(e: any) => formik.setFieldValue(`slab_Leaksection.title`, e.target.value)}
                  /> */}
                </div>
                {formik.values.slab_Leaksection.card && formik.values.slab_Leaksection.card.map((card: any, index: any) => (
                  <div key={index} style={{ marginBottom: '20px', position: 'relative' }}>
                    <h5>{index + 1} Slab_Leaksection Card</h5>
                    <DynamicInput
                      type="text"
                      name={`slab_Leaksection.card[${index}].cardTitle`}
                      placeholder="Card Title"
                      value={card.cardTitle}
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                    ...
                    <Editor
                      name={`slab_Leaksection.card[${index}].cardText`}
                      value={card.cardText}
                      onChange={(e: any) => formik.setFieldValue(`slab_Leaksection.card[${index}].cardText`, e.target.value)}
                    />

              
                    <FaTrash
                      onClick={() => handleslab_LeaksectionRemoveCard(index)}
                      className={styles.trashIcon}
                      style={{ right: "10px", top: "5px" }}
                    />
                  </div>
                ...
                <div className={styles.btnEnd}>
                  <Button
                    text="Add Card"
                    type="button"
                    handle={handleslab_LeaksectionAddCard}
                    className={styles.btnStyle}
                  >
                    Add Card
                  </Button>
                ...
                {formik.values.locationContent.map((locationItem: any, index: any) => (
                  <div key={index} className={styles.mb4}>
                    ...
                    <a
                      ...
                      onClick={(e) => handleAddLocationItem(index, e)}
                    >
                      Add Location Item
                    </a>
                    <div className="mb-3">
